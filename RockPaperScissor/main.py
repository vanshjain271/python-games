...
class GameUI:
    def __init__(self):
        ...
        self.userscore = Label(
            text="Match", font=FONT, bg=THEME_COLOR, fg="white", highlightthickness=0
        )
        ...
        # Computer Label:
        self.user_label = Label(
            text="Computer", bg=THEME_COLOR, fg="white", highlightthickness=0, font=FONT
        )
        ...
        self.computer_image = [
            self.img_Big_Rock,
            self.img_Big_Paper,
            self.img_Big_Scissor,
        ]

        # Interactive to User :: Win / Lose / Tie
        self.result = Label(
            text=None, bg=THEME_COLOR, fg=THEME_COLOR, font=("Courier", 20, "italic")
        )
